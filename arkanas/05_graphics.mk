...
.cairo-done:
	mkdir -p $(CAIRO_PATH)/build && cd $(CAIRO_PATH)/build && meson setup --native-file $(SRC_PATH)/cross_file.txt --prefix=/usr --buildtype=release -D tests=disabled .. && ninja && DESTDIR=$(STAGING_PATH) ninja install
	touch .cairo-done
